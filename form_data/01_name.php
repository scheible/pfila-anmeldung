<script type="text/javascript">
    function kindCheckForErrors() {
        if ($('#kind').val() === "") {
            setRed('kind');
            return [true, ("- Es wurde kein Teilnehmername eingetragen\n")];
        }   
        return [false, ""];
    }
...
<div class="formGroup" id="kindname">
    ...
    <input type="text" placeholder="Vorname Nachname Kind" name="Teilnehmer Name" id="kind" onchange="insertName(event);"/><br>
    <div>
