<form action="anmelden.php" method="POST">
	...
	<div class="formGroup">
		...
		<table>
			<tr>
				<td>Erstes Kind:</td>
				<td><?php echo number_format((float)$kostenKind, 2, ',', ''); ?> EUR</td>
			</tr>
			<tr>
				<td>Weiteres Kind:</td>
				<td> <?php echo number_format((float)$kostenWeiteresKind, 2, ',', ''); ?> EUR</td>
			</tr>
			<tr>
				<td>Rover/Leiter:</td>
				<td> <?php echo number_format((float)$kostenLeiter, 2, ',', ''); ?> EUR</td>
			</tr>
		</table>
		</p>
